  ...
  return (
    <footer className="border-t border-border/60 bg-ink text-background/85">
      <div className="mx-auto grid max-w-7xl gap-12 px-6 py-20 lg:grid-cols-4 lg:px-10">
        ...
        <div>
          <div className="mb-6 text-xs font-semibold uppercase tracking-[0.2em] text-background/50">Company</div>
          <ul className="space-y-3 text-sm">
            <li><Link to="/about" className="transition-colors hover:text-primary-glow">About</Link></li>
            <li><Link to="/services" className="transition-colors hover:text-primary-glow">Services</Link></li>
            <li><Link to="/projects" className="transition-colors hover:text-primary-glow">Projects</Link></li>
            <li><Link to="/contact" className="transition-colors hover:text-primary-glow">Contact</Link></li>
          </ul>
        </div>
        <div>
          <div className="mb-6 text-xs font-semibold uppercase tracking-[0.2em] text-background/50">Contact</div>
          <ul className="space-y-4 text-sm text-background/75">
            ...
            <li className="flex items-center gap-3 break-all transition-colors hover:text-background">
              ...
              <a href="mailto:info@tts.rw">info@tts.rw</a>
            </li>
      ...
      <div className="border-t border-background/10">
        <div className="mx-auto flex max-w-7xl flex-col items-start justify-between gap-4 px-6 py-8 text-xs text-background/50 md:flex-row md:items-center lg:px-10">
          ...
          <div className="flex items-center gap-2">
            ...
            Registered February 1988 · Rwanda
          </div>
        </div>
      </div>
    </footer>
