        ...
        <div className={`mx-auto flex max-w-7xl px-6 lg:px-10 transition-all duration-300 ${isCentered ? 'h-auto py-6' : 'h-24 items-center justify-between'}`}>
          {isCentered ? (
            ...
            <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 md:hidden flex items-center justify-center">
              <Link to="/" className="flex flex-shrink-0 items-center justify-center transition-transform hover:scale-105">
                <img src={currentLogo} alt="TTS" className="h-10 w-auto object-contain drop-shadow-md transition-all duration-300" />
              </Link>
            </div>
            ...
            <div className="hidden md:flex flex-[2] flex-col items-center justify-center gap-5">
              ...
              <nav className="hidden items-center justify-center gap-10 md:flex">
                {links.map((l) => (
                  ...
                  >
                    {l.label}
                    <span className={`absolute -bottom-1 left-0 h-px w-0 transition-all group-hover:w-full bg-white`} />
                  </Link>
                ))}
              </nav>
            </div>
          ...
          <div className="flex h-full w-full items-center justify-between relative">
            ...
            <nav className={`hidden flex-[2] items-center justify-center gap-10 md:flex ${isCentered ? '' : ''}`}>
              {links.map((l) => (
                ...
                >
                  {l.label}
                  <span className={`absolute -bottom-1 left-0 h-px w-0 transition-all group-hover:w-full bg-primary`} />
                </Link>
              ))}
            </nav>
