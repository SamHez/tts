...
export const Route = createFileRoute("/services")({
  head: () =>
    pageSeo({
      title: "Scaffolding Rental, Equipment & Maintenance Services Rwanda | TTS",
      description:
        "Trustable Technical Services provides cuplock scaffolding rental, construction equipment supply, site support and maintenance services for projects in Kigali and across Rwanda.",
      path: "/services",
      keywords:
        "scaffolding rental Rwanda, cuplock scaffolding Kigali, construction equipment Rwanda, maintenance services Kigali",
    }),
...
const services = [
  {
    ...
    items: [
      "Cuplock standards & ledgers",
      "Transoms, braces & base jacks",
      "Access stairs & guardrails",
      ...
      <section className="border-b border-border bg-secondary/50 bg-page-header">
        <FadeIn className="mx-auto max-w-7xl px-6 py-28 lg:px-10 text-center">
          ...
          <p className="mt-8 mx-auto max-w-2xl text-lg text-white">
            Three complementary capabilities, one trusted partner. We support your project from
            first survey through long-term operation.
          </p>
        </FadeIn>
      </section>
              ...
              {i === 0 && (
                <div className="md:col-span-12 hidden">
                  <img
                    ...
                    width={1200}
                    height={900}
                    className="mt-4 aspect-[21/9] w-full rounded-2xl object-cover"
                  />
                </div>
              )}
            </article>
